...
public class DialogUtils {
	...
	public static Dialog createDialog(Context context, int titleId, int messageId, DialogInterface.OnClickListener positiveButtonListener,
		...
		public static Dialog createNoNetworkDialog(Context context, DialogInterface.OnClickListener positiveButtonListener) {
			
				AlertDialog.Builder builder = new AlertDialog.Builder(context);
				builder.setTitle(R.string.alert_dialog_no_network_title);
				builder.setMessage(R.string.alert_dialog_no_network_string);
